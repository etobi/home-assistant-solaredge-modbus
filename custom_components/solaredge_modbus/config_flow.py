...
DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Required(CONF_INVERTER1_UNIT, default=DEFAULT_INVERTER_UNIT): bool,
        vol.Required(CONF_INVERTER2_UNIT, default=DEFAULT_DEACTIVATED_INVERTER_UNIT): bool,
        vol.Required(CONF_INVERTER3_UNIT, default=DEFAULT_DEACTIVATED_INVERTER_UNIT): bool,
